...
- Visit the [BACH Money Docs GitHub](https://github.com/TheStableFoundation/bach-money-docs) repository.
- Click on the "Use this template" button.
- Follow the prompts to create a new repository using this template.

<Callout variant="info">
Try BACH Money Docs in your browser: [open the template on StackBlitz](https://stackblitz.com/github/paydii/bach-money-docs)
</Callout>
