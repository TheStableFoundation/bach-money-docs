...
BACH Money Docs creates your site's HTML pages from your content, offering flexible options through Markdown frontmatter. Additionally, BACH Money Docs projects have complete access to [Astro's robust page generation tools](https://docs.astro.build/en/basics/astro-pages/). This guide explains how page generation works in BACH Money Docs.

## Content pages

### File formats

BACH Money Docs supports authoring content in Markdown and MDX with no configuration required. 
...
All BACH Money Docs pages share a customizable set of frontmatter properties that control their appearance:
